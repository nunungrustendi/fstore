...
@section('content')
	...
	<div class="row">
		...
		@if($product->count()==0)
			<div class="row m-4">Tidak ditemukan hasil pencarian untuk kata kunci : {{$title}}</div>
		@else
	...
	<hr>
		<div class="d-flex justify-content-center">{{$product->appends(['cari'=>$title])->links()}}</div>
	<hr>
@endsection